...
const offerings = [
  ...
  { name: 'Rubber', label: 'A NATURAL RESOURCE', description: 'Natural rubber forms part of our diverse plantation business.', image: `${basePath}/business/rubber.png`, path: 'rubber/' },
];
      ...
      <div className="wrap">
        ...
        <div className={styles.grid}>
          <motion.a {...reveal()} href={`${official}coconut/`} target="_blank" rel="noopener noreferrer" className={styles.feature} aria-label="Explore coconut products on the official KPL website (opens in a new tab)">
            <img src={`${basePath}/hero-sequence-v6/16-mobile.webp?v=6`} alt="Coconuts growing on a palm, illustrative plantation image" loading="lazy" />
